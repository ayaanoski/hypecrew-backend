...
router.route("/staff/bulk-update-events").post(jwtAuthMiddleware, bulkUpdateStaffEvents);
router.route("/staff/:staffId").patch(jwtAuthMiddleware, updateStaff);
